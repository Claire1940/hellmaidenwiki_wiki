...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    description: 'Copyright and intellectual property information for Hell Maiden Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Hell Maiden Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Hell Maiden Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Hell Maiden Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Steam</strong> - Owner of the Steam platform</li>
              <li><strong>Hell Maiden Developers</strong> - Creators of the Hell Maiden game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Hell Maiden</strong> - Trademark of the game developers</li>
              <li><strong>Hell Maiden Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Hell Maiden Wiki.
            </p>
            ...
            <p>
              ...
              Hell Maiden Wiki<br />
              Email: <a href="mailto:dmca@hellmaidenwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@hellmaidenwiki.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Hell Maiden Wiki"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Hell Maiden Wiki (hellmaidenwiki.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@hellmaidenwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@hellmaidenwiki.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@hellmaidenwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@hellmaidenwiki.wiki</a>
            </p>
            <p>
